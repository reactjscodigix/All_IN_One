...
import { ChevronDown, Search, Bell, Settings, LogOut, Menu, X, MoreVertical, Download, Filter as FilterIcon } from 'lucide-react';
    ...
    <div className="flex flex-col gap-8">
      ...
      <div>
        ...
        <nav className="space-y-1">
          ...
          <SimpleMenuItem icon="🧾" label="Invoices" />
          <SimpleMenuItem icon="💳" label="Payments" active />
