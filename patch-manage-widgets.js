...
content = content.replace(
  /<button className="p-2 bg-white border border-indigo-200 text-indigo-600 rounded-md text-sm font-medium flex items-center gap-2 hover:bg-indigo-50 transition-colors">(\s*)<Layout size=\{16\} \/>(\s*)Manage Widgets(\s*)<\/button>/,
...
// Wrap KPI CARDS
content = content.replace(
  /\{\/\* KPI CARDS \*\/\}\n(\s*)<div className="grid grid-cols-6 gap-2 mb-6">/,
