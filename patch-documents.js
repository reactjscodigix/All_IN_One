...
content = content.replace(
  /<button className="p-2 bg-white border border-gray-200 text-gray-700 rounded-md text-\[11px\] font-medium flex items-center gap-2  hover:bg-gray-50 transition-colors">/g,
