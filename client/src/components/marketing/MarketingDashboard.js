    ...
    <div className="min-h-screen bg-[#F8F9FA] p-6 font-sans">
            ...
            {TOP_CAMPAIGNS.slice(0, 4).map((c, i) => (
              <div key={i} className="flex justify-between items-center pb-4 border-b border-gray-50 last:border-0 last:pb-0">
                ...
                <div className="text-right">
                  <p className="text-sm font-bold text-gray-900">{c.leads}</p>
        ...
        <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex flex-col justify-between">
          ...
          <div className="space-y-4 mb-6">
            {RECENT_LEADS.slice(0, 2).map((l, i) => (
              <div key={i} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm" style={{backgroundColor: l.avatarBg || '#EDE9FE', color: l.badgeColor || '#4F46E5'}}>
                    {l.avatar}
                  </div>
                  <div>
                ...
                <div className="flex flex-col items-end gap-1">
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-full" style={{backgroundColor: `${l.badgeColor}20`, color: l.badgeColor}}>{l.badge}</span>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
              ...
              <p className="text-lg font-bold text-gray-900">10.1%</p>
            ...
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
              ...
              <p className="text-lg font-bold text-gray-900">$3,890</p>
            ...
            <div className="space-y-3 mt-1">
              {TASKS_DATA.map((t, i) => (
                <div key={i} className="flex items-center justify-between group cursor-pointer" onClick={() => toggleTask(i)}>
                  ...
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-full" style={{backgroundColor: `${t.priorityColor}20`, color: t.priorityColor}}>{t.priority}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-6">
              ...
              {CHANNEL_PERF.slice(0, 2).map((c, i) => (
                <div key={i}>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-bold text-gray-900">${c.revenue} <span className="text-gray-400 font-normal">({c.pct}%)</span></span>
                  </div>
          ...
          <div className="bg-[#6D28D9] p-6 rounded-xl shadow-lg flex-1 text-center text-white flex flex-col justify-center relative overflow-hidden">
            ...
            <h3 className="font-bold mb-4 relative z-10 text-[15px]">Campaign Status</h3>
            ...
            <button className="w-full py-2 bg-white/20 hover:bg-white/30 transition-colors rounded-lg text-sm font-bold relative z-10">View All Campaigns</button>
          </div>
        </div>
