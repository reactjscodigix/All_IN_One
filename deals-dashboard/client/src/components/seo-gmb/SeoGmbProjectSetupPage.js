    ...
    <div className="bg-slate-50 min-h-screen font-sans pb-10">
      ...
      {isCreateMode ? (
        <div className="flex flex-col min-h-screen">
          {/* Header */}
          <div className="bg-white border-b border-slate-200 py-4 px-6 flex items-center justify-between shadow-sm shrink-0">
            <div>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 rounded px-4 py-2 text-xs  cursor-pointer"
              >
                Cancel
              </button>
              <button
                onClick={() => createStep === 6 ? handleCreateProject() : setCreateStep(s => Math.min(6, s + 1))}
                className="bg-blue-600 hover:bg-blue-700 border-none text-white rounded px-4 py-2 text-xs  flex items-center gap-1 cursor-pointer transition-colors"
              >
          ...
          <div className="flex flex-col flex-1 p-6 gap-6">
            ...
            <div className="w-full shrink-0">
              <div className="bg-white border border-slate-200 rounded-2xl p-2 flex flex-row gap-2 shadow-sm overflow-x-auto no-scrollbar">
                {[
            ...
            <div className="flex-1 min-w-0 bg-white border border-slate-200 rounded-2xl p-6 shadow-sm overflow-y-auto max-h-[calc(100vh-210px)]">
              ...
              {createStep === 1 && (
                <div className="flex flex-col gap-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-xs">
                    <div>
                      <label className="block text-xs  text-slate-500 uppercase mb-1">Project Name *</label>
                      <input
                        type="text"
                        value={newProj.name}
                    ...
                    <div>
                      <label className="block text-xs  text-slate-500 uppercase mb-1">Business / Website Name *</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs  text-slate-500 uppercase mb-1">Website URL *</label>
                    ...
                    <div>
                      <label className="block text-xs  text-slate-500 uppercase mb-1">Project Type *</label>
                      <select
                        value={newProj.type}
                    ...
                    <div>
                      <label className="block text-xs  text-slate-500 uppercase mb-1">Country *</label>
                      <select
                    ...
                    <div>
                      <label className="block text-xs  text-slate-500 uppercase mb-1">City</label>
                      <input
                        type="text"
                        value={newProj.city}
                    ...
                    <div>
                      <label className="block text-xs  text-slate-500 uppercase mb-1">Project Start Date</label>
                      <input
                        type="date"
                    ...
                    <div>
                      <label className="block text-xs  text-slate-500 uppercase mb-1">Budget (INR / Month)</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-xs  text-slate-500 uppercase mb-1">Project Owner</label>
                      <select
                        value={newProj.owner}
                  ...
                  <div>
                    <label className="block text-xs  text-slate-500 uppercase mb-1.5">Project Description</label>
                    <textarea
                      rows={3}
                  ...
                  <div className="grid grid-cols-2 gap-5 mt-2">
                    <div>
                      <label className="block text-xs  text-slate-500 uppercase mb-2">Project Goals (Select all that apply)</label>
                    ...
                    <div>
                      <label className="block text-xs  text-slate-500 uppercase mb-2">Target Audience</label>
                  ...
                  <div className="border-t border-slate-100 pt-5">
                    <label className="block text-xs  text-slate-500 uppercase mb-3.5">SEO Modules to Enable</label>
                  ...
                  <div className="border-t border-slate-100 pt-5">
                    <label className="block text-xs  text-slate-500 uppercase mb-3.5">GMB Modules to Enable</label>
                  ...
                  {/* KPIs */}
                  <div className="border-t border-slate-100 pt-5">
                    <label className="block text-xs  text-slate-500 uppercase mb-3">Project KPIs (Primary Metrics)</label>
                  ...
                  {/* Competitors List */}
                  <div className="border-t border-slate-100 pt-5">
                    <label className="block text-xs  text-slate-500 uppercase mb-3">Competitors (Add up to 5)</label>
                  ...
                  {/* Options */}
                  <div className="border-t border-slate-100 pt-5">
                    <label className="block text-xs  text-slate-500 uppercase mb-3">Additional Options</label>
          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between mb-5 ">
              ...
              <div className="flex items-center gap-3">
                <button onClick={() => setIsCreateMode(true)} className="bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 rounded px-4 py-2 text-xs  flex items-center gap-1.5 cursor-pointer">
                  <PlusCircle size={14} className="text-blue-500" /> Add New Project
                </button>
                <button onClick={handleSaveProject} className="bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 rounded px-4 py-2 text-xs  flex items-center gap-1.5 cursor-pointer">
                  <Edit3 size={14} /> Save Project
                </button>
                <button
                  onClick={handleNextTab}
                  disabled={activeTab === 'Monthly Roadmap'}
                  className={`rounded px-4 py-2 text-xs  flex items-center gap-1.5 border-none cursor-pointer text-white transition-colors ${activeTab === 'Monthly Roadmap' ? 'bg-slate-300 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'
                    }`}
                >
            ...
            {activeTab === 'Project Onboarding' && (
              <div className="flex flex-col gap-6">
                <div className="bg-white rounded-2xl p-6 border border-slate-200 flex justify-between items-center relative overflow-hidden shadow-sm">
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    {[
                      ...
                      <div key={i} className={`border rounded p-4 flex items-center gap-3.5 ${item.bg}`}>
                        <div className="bg-white/90 rounded w-10 h-10 flex items-center justify-center shadow-sm shrink-0">
                          <item.icon size={20} />
                        </div>
                        <div>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                  ...
                  <div className="flex flex-wrap gap-2 text-xs">
                    {goals.map((g, i) => (
                      <div key={i} className="flex items-center gap-1.5 bg-blue-50 text-blue-700 border border-blue-100 rounded px-3 py-2 ">
                    ...
                    {isAddingGoal ? (
                      ...
                      <button
                        ...
                        className="border border-dashed border-blue-500 text-blue-500 hover:bg-blue-50/50 bg-white rounded px-3 py-2  flex items-center gap-1 cursor-pointer"
                      >
            ...
            <div className="flex justify-between items-center mt-6 pt-5 border-t border-slate-200">
              <button
                ...
                className={`rounded px-4 py-2.5 text-xs  border cursor-pointer transition-colors bg-white ${activeTab === 'Project Onboarding'
