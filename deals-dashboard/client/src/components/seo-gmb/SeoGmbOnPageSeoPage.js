        ...
        {activeTab === 'Landing Pages' && (
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-3 gap-5">
              ...
              {/* Radar Chart */}
              <div className="col-span-1 bg-white rounded-2xl p-5 border border-slate-200">
            ...
            <div className="grid grid-cols-5 gap-4">
              {[
                ...
                <div key={i} className="bg-white border border-slate-200 rounded-2xl p-4 flex flex-col justify-between hover:shadow-sm transition-shadow">
                  <div>
