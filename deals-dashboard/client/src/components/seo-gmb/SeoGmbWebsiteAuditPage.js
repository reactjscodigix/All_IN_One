  ...
  <div class="page">
    ...
    <div class="main-body">
      ...
      <div class="lower-split">
        <!-- Issues table left -->
        <div>
          <div style="font-size: 10px; font-weight:800; text-transform:uppercase; color:#0f172a; margin-bottom:8px;">Top Technical Issues</div>
        ...
        <div>
          <div style="font-size: 10px; font-weight:800; text-transform:uppercase; color:#0f172a; margin-bottom:8px;">Core Web Vitals</div>
          <div class="cwv-row">
            <div class="cwv-card">
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-5">
          ...
          <div className="flex gap-3">
            <button onClick={handleDownloadReport} className="bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 rounded px-4 py-2 text-xs  flex items-center gap-1.5 cursor-pointer">
              <FileText size={14} /> Download Report
            </button>
            <button onClick={handleRunNewAudit} className="bg-blue-500 hover:bg-blue-600 border-none text-white rounded px-4 py-2 text-xs  flex items-center gap-1.5 cursor-pointer transition-colors">
        ...
        <div className="grid grid-cols-3 gap-5 mb-5">
          ...
          <div className="col-span-2 bg-white rounded-2xl p-5 border border-slate-200 flex justify-between items-center gap-6">
            <div className="flex gap-4 items-center">
              {/* Site preview mockup thumbnail */}
              <div className="w-32 h-20 bg-slate-100 border border-slate-200 rounded shrink-0 overflow-hidden flex items-center justify-center relative shadow-sm">
              ...
              <div>
                ...
                <button onClick={() => setShowHistory(!showHistory)} className="bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 rounded px-3 py-1.5 text-xs  mt-3 cursor-pointer">
          ...
          <div className="col-span-1 grid grid-cols-2 gap-3.5">
            {[
              ...
              <div key={i} className={`border rounded p-3 px-4 flex items-center gap-3 ${stat.color}`}>
                <div className="bg-white/95 rounded w-8 h-8 flex items-center justify-center shadow-sm shrink-0">
                  <stat.icon size={16} />
                </div>
                <div>
            ...
            <div className="col-span-2 border rounded p-3 px-4 bg-emerald-50 text-emerald-600 border-emerald-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="bg-white/95 rounded w-8 h-8 flex items-center justify-center shadow-sm">
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200">
          ...
          <div className="grid grid-cols-3 gap-4">
            {CATEGORIES_DATA.map((c) => {
              ...
              return (
                <div key={c.id} className="border border-slate-200 rounded-2xl p-4 flex flex-col justify-between hover:shadow-sm hover:border-slate-300 transition-all">
      ...
      {selectedCategory && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-1/2 h-full bg-white shadow-2xl flex flex-col justify-between z-10 animate-slide-in">
                      ...
                      <div key={idx} className={`border rounded p-4 flex items-start justify-between gap-4 transition-all duration-300 ${iss.fixed ? 'opacity-65 border-emerald-200 bg-emerald-50/10' : 'border-slate-100 bg-slate-50/40'}`}>
                        ...
                        {!iss.fixed && (
                          <button
                            ...
                            className="bg-emerald-600 hover:bg-emerald-700 text-white text-xs  rounded px-2.5 py-1.5 cursor-pointer shrink-0 transition-colors border-none shadow-sm flex items-center gap-1"
                          >
                            Fix Issue
                          </button>
                        )}
            ...
            <div className="p-5 border-t border-slate-200 flex justify-between bg-slate-50/50">
              <button
                onClick={() => setSelectedCategory(null)}
                className="bg-white hover:bg-slate-100 border border-slate-200 text-slate-700 rounded px-4 py-2 text-xs  cursor-pointer"
              >
                Close Panel
              </button>
              <button
                ...
                className="bg-blue-500 hover:bg-blue-600 text-white rounded px-4 py-2 text-xs  cursor-pointer border-none flex items-center gap-1.5 disabled:bg-slate-300 disabled:cursor-not-allowed"
              >
