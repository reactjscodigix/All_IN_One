    ...
    <div className="bg-slate-50 min-h-screen font-sans pb-10">
      ...
      <div className="bg-white border-b border-slate-200 py-3.5 px-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          {/* Google G logo */}
          <div className="w-9 h-9 rounded border border-slate-200 flex items-center justify-center bg-white shadow-sm flex-shrink-0">
      ...
      <div className="px-6 py-4">
        ...
        <div className="flex gap-1 mb-5 bg-white p-1 rounded border border-slate-200 overflow-x-auto whitespace-nowrap scrollbar-none">
          {TABS.map(({ id, icon: Icon }) => (
            <button
              ...
              className={`flex items-center gap-1.5 py-2.5 px-3 rounded text-xs  cursor-pointer border-none outline-none transition-all shrink-0 ${activeTab === id ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-slate-500 hover:bg-slate-50'
                }`}
            >
              <Icon size={12} /> {id}
            </button>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-3 gap-5">
              ...
              <div className="col-span-1 bg-white rounded-2xl border border-slate-200 p-5">
                ...
                <table className="w-full text-xs text-slate-700">
                  <thead><tr className="text-[9px] text-slate-400  uppercase border-b border-slate-100"><th className="pb-1.5 text-left">Page</th><th className="pb-1.5 text-right">Users</th><th className="pb-1.5 text-right">Sessions</th><th className="pb-1.5 text-right">Bounce</th></tr></thead>
                  <tbody>
            ...
            <div className="grid grid-cols-3 gap-5">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-5">
                ...
                <table className="w-full text-xs text-slate-700">
                  <thead><tr className="text-[9px] text-slate-400  uppercase border-b border-slate-100"><th className="pb-1.5 text-left">Event / Goal</th><th className="pb-1.5 text-right">Completions</th><th className="pb-1.5 text-right">Rate</th><th className="pb-1.5 text-right">Trend</th></tr></thead>
                  <tbody>
        ...
        {activeTab === 'Search Console' && (
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 mb-1">
