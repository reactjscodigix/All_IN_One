      ...
      <div className="bg-white border-b border-slate-200 py-3.5 px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="bg-indigo-500 hover:bg-indigo-600 border-none text-white rounded px-4 py-2 text-xs  flex items-center gap-1.5 cursor-pointer transition-colors"
          >
        ...
        <div className="flex gap-1 mb-5 bg-white p-1 rounded border border-slate-200 overflow-x-auto whitespace-nowrap scrollbar-none">
          {TABS.map(({ id, icon: Icon }) => (
            <button
              ...
              className={`flex items-center gap-1.5 py-2.5 px-4 rounded text-xs  cursor-pointer border-none outline-none transition-all shrink-0 ${activeTab === id ? 'bg-indigo-50 text-indigo-600 shadow-sm' : 'text-slate-500 hover:bg-slate-50'
                }`}
            >
              <Icon size={12} /> {id}
            </button>
          ...
          <div className="flex flex-col gap-5">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="bg-indigo-500 hover:bg-indigo-600 border-none text-white rounded px-3 py-1.5 text-xs  flex items-center gap-1.5 cursor-pointer transition-colors"
                  >
            ...
            <div className="grid grid-cols-6 gap-4">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-4">
                ...
                <table className="w-full text-xs">
                  <thead><tr className="text-[9px] text-slate-400  uppercase border-b border-slate-100"><th className="pb-1.5 text-left">City</th><th className="pb-1.5 text-center">Avg Rank</th><th className="pb-1.5 text-center">Δ</th></tr></thead>
                  <tbody>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-4">
                ...
                <table className="w-full text-xs">
                  <thead><tr className="text-[9px] text-slate-400  uppercase border-b border-slate-100"><th className="pb-1.5 text-left">Device</th><th className="pb-1.5 text-center">Avg</th><th className="pb-1.5 text-center">Δ</th></tr></thead>
                  <tbody>
