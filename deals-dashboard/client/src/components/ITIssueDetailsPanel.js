...
const ITIssueDetailsPanel = ({ issue, updateIssue, deleteIssue, onClose }) => {
  // Core sync states
  ...
  const handleSuggestSubtasks = () => {
    ...
    setTimeout(() => {
      setSubtasks(prev => [
        ...prev,
        { id: Date.now() + 1, title: 'Draft accessibility layout specs', completed: false },
        { id: Date.now() + 2, title: 'Review typography size hierarchy', completed: false },
        { id: Date.now() + 3, title: 'Validate color contrast scores against WCAG', completed: false }
      ]);
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <div className="interactive-dropdown relative">
                <button
                  ...
                  className="flex items-center gap-1.5 px-2.5 py-1.5 rounded border border-blue-400 bg-blue-50 text-gray-700 hover:bg-blue-100 transition font-medium text-[13px] mr-2"
                >
                  <Sparkles size={14} className="text-gray-600 fill-gray-600" />
                ...
                {openDropdown === 'header-ai-actions' && (
                  <div className="absolute right-0 top-full mt-1.5 w-60 bg-white border border-gray-200 rounded shadow-[0_4px_12px_rgba(0,0,0,0.1)] py-1.5 z-50 text-[14px]">
                    <div className="px-4 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-gray-700 transition">
                ...
                <div className="space-y-2 mt-2">
                  ...
                  <div className="border border-gray-200 rounded p-2 flex items-center justify-between bg-white text-xs shadow-sm">
                    ...
                    <button
                      ...
                      className="border border-gray-200 rounded px-2.5 py-1 text-[11px] text-gray-700 font-bold hover:bg-gray-50 bg-white transition shadow-sm"
                    >
          ...
          <div className={`${isExpanded ? 'w-1/3 border-l border-gray-200 pl-8 space-y-6' : 'w-full space-y-6'}`}>
            ...
            {isExpanded && (
              <div className="flex items-center gap-2 flex-wrap mb-2">
                ...
                <button className="flex items-center gap-1.5 px-2.5 py-1.5 border border-gray-300 rounded hover:bg-gray-50 transition text-xs font-semibold text-gray-700">
                  <Sparkles size={13} className="text-purple-600" /> Improve Task
                </button>
              </div>
            )}
