              ...
              <div className="bg-white rounded border border-gray-200  overflow-hidden">
                <div className="p-2 bg-orange-50/50 border-b border-gray-200 flex items-center gap-2">
                  <div className="bg-orange-100 p-1.5 rounded border border-orange-200">
                    <div className="w-4 h-4 bg-orange-500 rounded flex items-center justify-center text-[10px] text-white font-[500]">Q</div>
                  </div>
                  <h3 className="text-sm  text-gray-800">Quotation Info</h3>
                </div>
                <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4">
                  <div>
                    <label className="block text-[10px]  text-gray-400  mb-1">Quotation Number</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      <label className="block text-[10px]  text-gray-400 ">Deal</label>
                      <button type="button" className="text-[10px]  text-blue-600 hover:text-blue-700">View Deal</button>
                    </div>
                    <select
                      name="deal_id"
                  ...
                  <div>
                    <label className="block text-[10px]  text-gray-400  mb-1">Client</label>
                    <input
                      type="text"
                      name="client"
                  ...
                  <div>
                    <label className="block text-[10px]  text-gray-400  mb-1">Quotation Date</label>
                    <input
                      type="date"
                      name="quotationDate"
              ...
              <div className="bg-white rounded border border-gray-200  overflow-hidden mt-2">
                <div className="p-2 bg-blue-50/50 border-b border-gray-200 flex items-center gap-2">
                  <div className="bg-blue-100 p-1.5 rounded border border-blue-200">
                    <div className="w-4 h-4 bg-blue-600 rounded flex items-center justify-center text-[10px] text-white font-[500]">C</div>
                  </div>
                ...
                <div className="p-4 ">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-2">
                    ...
                    <div>
                      <label className="block text-[10px]  text-gray-400  mb-1">Business Type</label>
                      <input
                        type="text"
                        name="businessType"
                    ...
                    <div>
                      <label className="block text-[10px]  text-gray-400  mb-1">Assigned Sales Executive</label>
                      <div className="flex items-center gap-2 p-2 border border-gray-200 rounded bg-white focus-within:ring-1 focus-within:ring-blue-500">
                        <div className="w-6 h-6 rounded bg-blue-100 flex items-center justify-center text-[10px]  text-blue-600">
                    ...
                    <div>
                      <label className="block text-[10px]  text-gray-400  mb-1">Client Email</label>
                      <input
                        type="email"
                        name="client_email"
                    ...
                    <div>
                      <label className="block text-[10px]  text-gray-400  mb-1">Client Phone</label>
                      <input
                        type="text"
                        name="client_phone"
                    ...
                    <div>
                      <label className="block text-[10px]  text-gray-400  mb-1">Referral</label>
                      <input
                        type="text"
                        name="referral_name"
                  ...
                  <div className="mb-4">
                    <label className="block text-[10px]  text-gray-400  mb-1">Project/Business Description</label>
                    <textarea
                    ...
                    <table className="w-full text-left">
                      <thead>
                        <tr className="border-b border-gray-100">
                          <th className="p-2 text-[10px]  text-gray-400  w-[25%]">Service</th>
                          <th className="p-2 text-[10px]  text-gray-400  w-[20%]">Description</th>
                          <th className="p-2 text-[10px]  text-gray-400  w-[15%]">Duration</th>
                          <th className="p-2 text-[10px]  text-gray-400  w-[15%] text-right pr-2">Rate</th>
                          <th className="p-2 text-[10px]  text-gray-400  w-[15%] text-right pr-2">Total</th>
                ...
                <div className="bg-white rounded border border-gray-200  overflow-hidden">
                  <div className="p-2 bg-gray-50/50 border-b border-gray-200 flex items-center gap-2">
                    <div className="bg-green-100 p-1.5 rounded border border-green-200">
                      <div className="w-4 h-4 bg-green-600 rounded flex items-center justify-center text-[10px] text-white ">P</div>
                    </div>
                ...
                <div className="bg-white rounded border border-gray-200  overflow-hidden">
                  <div className="p-2 bg-gray-50/50 border-b border-gray-200 flex items-center gap-2">
                    <div className="bg-yellow-100 p-1.5 rounded border border-yellow-200">
                      <div className="w-4 h-4 bg-yellow-600 rounded flex items-center justify-center text-[10px] text-white ">N</div>
                    </div>
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="flex justify-between items-center text-xs">
                    <div className="flex items-center gap-1">
                      ...
                      <div className="w-3.5 h-3.5 rounded-full border border-gray-200 flex items-center justify-center text-[10px] text-gray-300 cursor-help">i</div>
                    </div>
                    <input
                      type="number"
                      name="discount"
                ...
                <div className="p-4 space-y-4">
                  {formData.versionHistory.map((v, i) => (
                    <div key={i} className={`flex items-start gap-3 ${i > 0 ? 'opacity-50' : ''}`}>
                      <div className="w-8 h-8 rounded bg-gray-50 border border-gray-100 flex items-center justify-center text-[10px] font-[500] text-gray-400">{v.version.toUpperCase()}</div>
                ...
                <div className="p-4 space-y-4">
                  ...
                  {formData.isRevision && (
                    <div className="space-y-4 animate-in fade-in slide-in-from-top-1">
                      <div>
                        <label className="text-[10px]  text-gray-400  mb-1 block">Revision Number</label>
                      ...
                      <div>
                        <label className="text-[10px]  text-gray-400  mb-1 block">Revision Reason</label>
                        <div className="flex justify-between items-center text-xs text-gray-700 border-b border-gray-50 pb-1 cursor-pointer">
                      ...
                      <div>
                        <label className="text-[10px]  text-gray-400  mb-1 block">Revision Date</label>
                        <div className="flex justify-between items-center text-xs text-gray-700 border-b border-gray-50 pb-1 cursor-pointer">
        ...
        <div className="p-2 bg-white border-t border-gray-200 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <button
              type="button"
              onClick={handleSubmit}
              className="p-2 bg-green-600 text-white rounded text-xs  hover:bg-green-700 transition-all shadow-sm"
            >
              Save Quotation
            </button>
            <button
              ...
              className="p-2 bg-blue-500 text-white rounded text-xs  hover:bg-blue-600 transition-all shadow-sm"
            >
              Send to Client
            </button>
            ...
            {initialData && initialData.id && initialData.id !== 'NEW' && (
              <button
                ...
                className="p-2 bg-orange-500 text-white rounded text-xs  hover:bg-orange-600 transition-all shadow-sm"
              >
                Create Revision
              </button>
            )}
