      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <div style={{ fontSize: '13px', color: '#6B7280', fontFamily: "'Poppins', sans-serif" }}>
            <span>Home</span> <span style={{ margin: '0 8px' }}>/</span> <span>Companies</span>
          </div>
        </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ backgroundColor: '#F9FAFB', borderBottom: '1px solid #E5E7EB' }}>
                  ...
                  <th style={{ padding: '16px 12px', textAlign: 'left', fontSize: '12px', fontWeight: '600', color: '#6B7280', fontFamily: "'Poppins', sans-serif" }}>Account URL</th>
              ...
              <tbody>
                {companiesData.companies.map((company) => {
                  ...
                  return (
                    <tr key={company.id} style={{ borderBottom: '1px solid #E5E7EB', transition: 'background-color 0.2s' }}>
                      ...
                      <td style={{ padding: '16px 8px', textAlign: 'center' }}>
                        <span 
                          ...
                          style={{ fontSize: '16px', cursor: 'pointer', display: 'inline-block', color: starred[company.id] ? '#FFC107' : '#D1D5DB' }}
                        >
                          {starred[company.id] ? '★' : '☆'}
                        </span>
                      </td>
                      <td style={{ padding: '16px 12px', textAlign: 'left', fontSize: '13px', color: '#1F2937', fontFamily: "'Poppins', sans-serif", fontWeight: '600', display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <div style={{ width: '36px', height: '36px', borderRadius: '50%', backgroundColor: getAvatarColor(company.id), display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#FFF', fontSize: '12px', fontWeight: '700', flexShrink: 0 }}>
                          {getInitials(company.name)}
                        </div>
                        <span>{company.name}</span>
                      </td>
                      <td style={{ padding: '16px 12px', textAlign: 'left', fontSize: '13px', color: '#6B7280', fontFamily: "'Poppins', sans-serif" }}>{company.email}</td>
                      <td style={{ padding: '16px 12px', textAlign: 'left', fontSize: '13px', color: '#6B7280', fontFamily: "'Poppins', sans-serif" }}>{company.accountUrl}</td>
                      <td style={{ padding: '16px 12px', textAlign: 'left', fontSize: '13px', fontFamily: "'Poppins', sans-serif", display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <span style={{ color: '#6B7280' }}>{company.plan}</span>
                        <button style={{ background: 'none', border: 'none', padding: 0, fontSize: '12px', color: '#0D6EFD', fontFamily: "'Poppins', sans-serif", fontWeight: '600', cursor: 'pointer', textDecoration: 'underline' }}>
                          Upgrade
                        </button>
                      </td>
                      <td style={{ padding: '16px 12px', textAlign: 'left', fontSize: '13px', color: '#6B7280', fontFamily: "'Poppins', sans-serif" }}>{company.createdDate}</td>
                      <td style={{ padding: '16px 12px', textAlign: 'left' }}>
