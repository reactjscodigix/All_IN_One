      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center bg-white border border-gray-200 rounded overflow-hidden shadow-sm">
            <button 
              onClick={onExport}
              className="flex items-center gap-2 px-4 py-2 text-xs text-gray-600 hover:bg-gray-50 border-r border-gray-100 transition-colors"
            >
              <Download size={14} />
              Export
              <ChevronDown size={12} />
          ...
          <button
            onClick={onAdd}
            className="bg-red-600 text-white px-4 py-2 rounded text-xs  hover:bg-red-700 transition-all flex items-center gap-2 shadow-sm"
          >
