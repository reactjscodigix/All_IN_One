    ...
    <div className="bg-[#f8fafc] min-h-screen p-6 font-sans flex flex-col gap-6 text-gray-900">
      ...
      <div className="flex gap-6 relative">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="relative flex-1 max-w-sm">
              ...
              <input type="text" placeholder="Search keyword or activity..." className="w-full pl-9 pr-8 py-2 bg-white border border-gray-200 rounded text-xs focus:outline-none focus:border-blue-500 shadow-sm" />
              <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[9px]  text-gray-400 bg-gray-100 px-1.5 py-0.5 rounded">⌘ K</span>
            </div>

            <div className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-200 rounded shadow-sm cursor-pointer hover:bg-gray-50">
              <span className="text-xs  text-gray-700">All Activities</span>
              <ChevronDown size={14} className="text-gray-400" />
            </div>

            <div className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-200 rounded shadow-sm cursor-pointer hover:bg-gray-50">
              <span className="text-xs  text-gray-700">All Modules</span>
              <ChevronDown size={14} className="text-gray-400" />
            </div>

            <div className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-200 rounded shadow-sm cursor-pointer hover:bg-gray-50">
              <span className="text-xs  text-gray-700">All Users</span>
              <ChevronDown size={14} className="text-gray-400" />
            </div>

            <div className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-200 rounded shadow-sm cursor-pointer hover:bg-gray-50">
              <Calendar size={14} className="text-gray-500" />
              <span className="text-xs  text-gray-700">20 May 2024 - 26 May 2024</span>
            </div>

            <button className="flex items-center gap-1.5 px-3 py-2 bg-white border border-gray-200 rounded shadow-sm text-gray-700 text-xs  hover:bg-gray-50 ml-auto">
          ...
          <div className="bg-white rounded shadow-sm border border-gray-100">
            {activitiesList.map((activity, index) => {
              ...
              return (
                <div
                  ...
                  className={`flex gap-4 p-5 cursor-pointer transition-colors border-b border-gray-100 last:border-0 
            ...
            <div className="p-4 border-t border-gray-100 flex justify-between items-center bg-gray-50 rounded-b-xl">
              <span className="text-xs  text-gray-500">Showing 1 to 10 of 1,248 activities</span>
              <div className="flex items-center gap-1">
                ...
                <button className="w-6 h-6 flex items-center justify-center bg-red-600 text-white rounded text-xs  shadow-sm">1</button>
        ...
        {isPanelOpen && selectedActivity && (
          ...
          <div className="bg-white rounded shadow-sm border border-gray-100 sticky top-6">
            ...
            <div className="p-5">
              ...
              <div className="pt-4 border-t border-gray-100">
                ...
                <button className="w-full flex items-center justify-between px-3 py-2 border border-gray-200 rounded text-xs  text-gray-700 hover:bg-gray-50 shadow-sm transition-colors">
