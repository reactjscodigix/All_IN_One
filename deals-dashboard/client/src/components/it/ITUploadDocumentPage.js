      ...
      <div className="flex items-start gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-5">
              <div>
                ...
                <input type="text" name="title" value={form.title} onChange={handleChange} placeholder="Enter document title" className="w-full text-[13px] px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500" required />
              </div>

              <div>
                <label className="block text-[12px] font-medium text-gray-700 mb-1.5">Project <span className="text-red-500">*</span></label>
                <div className="relative">
                  <select name="project" value={form.project} onChange={handleChange} className="w-full text-[13px] px-3 py-2 border border-gray-200 rounded-md appearance-none focus:outline-none focus:ring-1 focus:ring-indigo-500 bg-white" required>
              ...
              <div>
                ...
                <div className="relative">
                  <select name="category" value={form.category} onChange={handleChange} className="w-full text-[13px] px-3 py-2 border border-gray-200 rounded-md appearance-none focus:outline-none focus:ring-1 focus:ring-indigo-500 bg-white" required>
              ...
              <div>
                ...
                <div className="relative">
                  <select name="folder" value={form.folder} onChange={handleChange} className="w-full text-[13px] px-3 py-2 border border-gray-200 rounded-md appearance-none focus:outline-none focus:ring-1 focus:ring-indigo-500 bg-white">
              ...
              <div>
                ...
                <div className="relative">
                  <select name="fileType" value={form.fileType} onChange={handleChange} className="w-full text-[13px] px-3 py-2 border border-gray-200 rounded-md appearance-none focus:outline-none focus:ring-1 focus:ring-indigo-500 bg-white" required>
              ...
              <div>
                ...
                <input type="text" name="version" value={form.version} onChange={handleChange} placeholder="1.0" className="w-full text-[13px] px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500" />
              </div>

              <div className="col-span-2">
                <label className="block text-[12px] font-medium text-gray-700 mb-1.5">Description</label>
                <textarea name="description" value={form.description} onChange={handleChange} placeholder="Enter document description (optional)" rows="3" className="w-full text-[13px] px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 resize-none"></textarea>
              ...
              <div className="col-span-2">
                ...
                <input type="text" name="tags" value={form.tags} onChange={handleChange} placeholder="Add tags and press Enter" className="w-full text-[13px] px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500" />
                <div className="text-[11px] text-gray-400 mt-1">Add relevant tags to easily find your document</div>
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="border border-dashed border-gray-300 rounded-lg p-10 flex flex-col items-center justify-center bg-gray-50/50">
            ...
            <div className="grid grid-cols-2 gap-6 mt-8">
              <div>
                ...
                <input type="email" name="linkedEmail" value={form.linkedEmail} onChange={handleChange} className="w-full text-[13px] px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500" />
                <div className="text-[11px] text-gray-400 mt-1">Document will be linked to this registered email</div>
              </div>
              <div>
                <label className="block text-[12px] font-medium text-gray-700 mb-1.5">Notify Team Members</label>
                <input type="text" name="notifyMembers" value={form.notifyMembers} onChange={handleChange} placeholder="Select team members to notify" className="w-full text-[13px] px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500" />
                <div className="text-[11px] text-gray-400 mt-1">Selected members will receive email notification</div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-4 gap-4">
                <div onClick={() => setAccess('Private')} className={`border rounded-lg p-4 cursor-pointer transition-colors ${form.accessPermission === 'Private' ? 'border-indigo-500 bg-indigo-50/30' : 'border-gray-200 bg-white hover:border-gray-300'}`}>
                  ...
                  <div className="text-[11px] text-gray-500 ml-5.5 pl-1 leading-snug">Only you can access this document</div>
                </div>

                <div onClick={() => setAccess('Team')} className={`border rounded-lg p-4 cursor-pointer transition-colors ${form.accessPermission === 'Team' ? 'border-indigo-500 bg-indigo-50/30' : 'border-gray-200 bg-white hover:border-gray-300'}`}>
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="text-[11px] text-gray-500 ml-5.5 pl-1 leading-snug">All project team members can access</div>
                </div>

                <div onClick={() => setAccess('Department')} className={`border rounded-lg p-4 cursor-pointer transition-colors ${form.accessPermission === 'Department' ? 'border-indigo-500 bg-indigo-50/30' : 'border-gray-200 bg-white hover:border-gray-300'}`}>
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="text-[11px] text-gray-500 ml-5.5 pl-1 leading-snug">All IT department members can access</div>
                </div>

                <div onClick={() => setAccess('Public')} className={`border rounded-lg p-4 cursor-pointer transition-colors ${form.accessPermission === 'Public' ? 'border-indigo-500 bg-indigo-50/30' : 'border-gray-200 bg-white hover:border-gray-300'}`}>
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="text-[11px] text-gray-500 ml-5.5 pl-1 leading-snug">Anyone with the link can view</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
              <button type="button" onClick={() => navigate(`/${deptPath}/${rolePath}/${username || user?.username}/documents`)} className="px-5 py-2.5 text-[13px] font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors">
                Cancel
              </button>
              <button type="button" className="px-5 py-2.5 text-[13px] font-medium text-indigo-600 bg-white border border-indigo-200 hover:bg-indigo-50 rounded-lg transition-colors shadow-sm">
                Save as Draft
              </button>
              <button type="button" onClick={handleSubmit} className="px-5 py-2.5 text-[13px] font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg transition-colors shadow-sm">
                Upload Document
              </button>
            </div>
          </div>
        ...
        <div className="w-[320px] shrink-0 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-gray-500">PDF, DOC, DOCX, TXT, RTF</div>
                </div>
              </div>
              <div className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-gray-500">XLS, XLSX, CSV, Google Sheets</div>
                </div>
              </div>
              <div className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-gray-500">PPT, PPTX, Google Slides</div>
                </div>
              </div>
              <div className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-gray-500">JPG, PNG, GIF, BMP, SVG</div>
                </div>
              </div>
              <div className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-gray-500">ZIP, RAR, 7Z, TAR, GZ</div>
                </div>
              </div>
              <div className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-gray-500">JSON, XML, ZIP, etc.</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            <button className="text-[12px] font-medium text-indigo-600 border border-indigo-200 bg-white hover:bg-indigo-50 px-4 py-2 rounded transition-colors shadow-sm">
              View Documentation ↗
            </button>
          </div>
        </div>
