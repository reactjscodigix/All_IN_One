...
export default function ITFileManagerPage() {
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen p-6 font-sans text-gray-900 relative" onClick={() => { setShowSortMenu(false); setContextMenu(null); }}>
      ...
      {/* Toast Notification */}
      {notification && (
        <div className="fixed top-5 right-6 z-50 bg-gray-900 text-white text-xs  p-2.5 rounded shadow-xl flex items-center gap-2 animate-pulse">
      ...
      <div className="grid grid-cols-5 gap-4 mb-6">
        {kpis.map((kpi, idx) => {
          if (kpi.type === 'progress') {
            return (
              <div key={idx} className="bg-white p-4 rounded shadow-sm border border-gray-100 flex items-center justify-between">
                <div>
          ...
          return (
            <div key={idx} className="bg-white p-4 rounded shadow-sm border border-gray-100 flex items-center gap-4">
      ...
      <div className="flex gap-6">
        ...
        <div className="w-[250px] shrink-0 space-y-5">
          ...
          <div className="bg-white rounded shadow-sm border border-gray-100 overflow-hidden">
            <h3 className="text-[12px] font-extrabold text-gray-700 uppercase tracking-wider p-4 pb-2">Storage Locations</h3>
              ...
              {STORAGE_LOCATIONS.map((loc) => {
                ...
                return (
                  <li
                    ...
                    className={`flex items-center justify-between px-3 py-2 rounded cursor-pointer text-[12px]  transition-colors
          ...
          {/* Quick Access */}
          <div className="bg-white rounded shadow-sm border border-gray-100 overflow-hidden">
            <h3 className="text-[12px] font-extrabold text-gray-700 uppercase tracking-wider p-4 pb-2">Quick Access</h3>
            <ul className="p-2 space-y-0.5">
          ...
          <div className="bg-white rounded shadow-sm border border-gray-100 p-4">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-[12px] font-extrabold text-gray-700 uppercase tracking-wider">Storage Details</h3>
        ...
        <div className="flex-1 bg-white rounded shadow-sm border border-gray-100 flex flex-col overflow-hidden">
          ...
          <div className="p-4 border-b border-gray-100 flex justify-between items-center">
            ...
            <div className="flex items-center gap-1">
              <button onClick={() => setViewMode('list')} className={`w-8 h-8 flex items-center justify-center rounded border transition-colors ${viewMode === 'list' ? 'bg-gray-100 text-gray-700 border-gray-200 shadow-sm' : 'text-gray-400 border-transparent hover:bg-gray-50'}`}>
                <List size={16} />
              </button>
              <button onClick={() => setViewMode('grid')} className={`w-8 h-8 flex items-center justify-center rounded border transition-colors ${viewMode === 'grid' ? 'bg-gray-100 text-gray-700 border-gray-200 shadow-sm' : 'text-gray-400 border-transparent hover:bg-gray-50'}`}>
                <LayoutGrid size={16} />
              </button>
          ...
          <div className="p-3 flex gap-2 border-b border-gray-100">
            <div className="relative max-w-[260px] flex-1">
              ...
              <input
                ...
                className="w-full pl-8 pr-4 py-1.5 bg-white border border-gray-200 rounded text-xs focus:outline-none focus:border-blue-500 shadow-sm"
              />
              {searchTerm && (
            ...
            <button className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-gray-200 rounded shadow-sm text-gray-700 text-xs  hover:bg-gray-50">
            ...
            <div className="relative ml-auto" onClick={e => e.stopPropagation()}>
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-200 rounded shadow-sm cursor-pointer hover:bg-gray-50 text-xs  text-gray-700"
              >
            ...
            <button className="px-2 py-1.5 border border-gray-200 rounded shadow-sm hover:bg-gray-50 text-gray-500">
          ...
          <div className="p-3 border-t border-gray-100 flex justify-between items-center bg-white">
            ...
            <div className="flex items-center gap-1">
              ...
              {[1, 2, 3, 4, 5].map(pg => (
                <button key={pg} className={`w-7 h-7 flex items-center justify-center rounded text-xs  ${pg === 1 ? 'bg-red-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100'}`}>{pg}</button>
              ))}
