  ...
  const handleSuggestSubtasks = async () => {
    ...
    try {
      ...
      Swal.fire({
        ...
        html: `<div class="p-3 bg-gray-50 border border-gray-200 rounded-lg max-h-60 overflow-y-auto">${subtaskHTML}</div>`,
  ...
  return (
    <>
      ...
      <div 
        className={
          isExpanded
            ? "fixed inset-8 md:inset-x-24 md:inset-y-12 bg-white rounded-lg shadow-2xl z-50 flex flex-col font-sans text-gray-800 overflow-hidden animate-fade-in"
      ...
      <div className={`flex-1 overflow-y-auto p-5 custom-scrollbar pb-24 ${isExpanded ? 'flex gap-8' : 'space-y-6'}`}>
        
        {/* Left Column (Main Content) */}
        <div className={`space-y-6 ${isExpanded ? 'w-2/3' : 'w-full'}`}>

          {duplicateWarning.length > 0 && (
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 text-xs flex gap-3 text-amber-800 animate-fade-in shadow-sm">
              <span className="text-base shrink-0">⚠️</span>
              <div className="space-y-1.5">
                <p className="font-bold">Potential Duplicate Issues Detected</p>
          ...
          {isEditingTitle ? (
            <div className="flex flex-col">
              <input 
                ...
                className="w-full text-[22px] font-bold text-gray-800 border-2 border-blue-500 rounded px-2.5 py-1.5 outline-none shadow-sm"
                autoFocus
              />
              <div className="flex justify-between items-center mt-2">
                <div className="flex gap-2">
                  <button className="w-8 h-8 flex items-center justify-center border border-gray-200 rounded shadow-sm hover:bg-gray-50 transition text-gray-700 bg-white">
                    <Plus size={16} />
                  </button>
                  <button className="w-8 h-8 flex items-center justify-center border border-gray-200 rounded shadow-sm hover:bg-gray-50 transition text-gray-700 bg-white">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className="w-8 h-8 flex items-center justify-center border border-gray-200 rounded shadow-sm hover:bg-gray-50 transition text-gray-700 bg-white"
                  >
                    <Check size={16} />
                  </button>
                  <button 
            ...
            <h2 
              ...
              className="text-[22px] font-bold text-gray-800 leading-snug break-words hover:bg-gray-50 p-1.5 -ml-1.5 rounded cursor-pointer transition border border-transparent hover:border-gray-300"
            >
              {title}
            </h2>
          )}
          ...
          <div className="interactive-dropdown relative">
            ...
            {openDropdown === 'header-ai-actions' && (
              <div className="absolute right-0 top-full mt-1.5 w-60 bg-white border border-gray-200 rounded shadow-[0_4px_12px_rgba(0,0,0,0.1)] py-1.5 z-50 text-[14px]">
                <div onClick={handleSideBySideImprove} className="px-4 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-gray-700 transition">
                  <FileEdit size={16} className="text-gray-700" />
                  <span>Improve description</span>
                </div>
                <div onClick={handleLinkConfluence} className="px-4 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-gray-700 transition">
                  <FileText size={16} className="text-gray-700" />
                  <span>Link Confluence content</span>
                </div>
                <div onClick={handleSummarizeComments} className="px-4 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-gray-700 transition">
                  <AlignLeft size={16} className="text-gray-700" />
                  <span>Summarize comments</span>
                </div>
                <div onClick={handleDetailedSubtaskSuggest} className="px-4 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-gray-700 transition">
                  <Network size={16} className="text-gray-700" />
                  <span>Suggest child work items</span>
                </div>
                <div onClick={handleLinkSimilar} className="px-4 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-gray-700 transition">
                ...
                <div className="border-t border-gray-100 mt-1.5 pt-1.5 px-4 py-1.5 flex items-center gap-2">
                  ...
                  <span className="text-[10px] text-gray-400 font-medium tracking-wide">Powered by DeepSeek AI</span>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            {!isImprovingSideBySide && (
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 text-[11px] font-semibold text-indigo-700 bg-indigo-50 border border-indigo-200 rounded hover:bg-indigo-100 transition shadow-sm cursor-pointer disabled:opacity-50"
              >
          ...
          {isImprovingSideBySide ? (
            <div className="border border-indigo-200 rounded-lg p-3 bg-indigo-50/30 space-y-3 shadow-sm animate-fade-in">
              <div className="flex items-center justify-between pb-1.5 border-b border-indigo-100">
                ...
                <span className="text-[10px] text-gray-500 font-medium">Verify changes before accepting</span>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* Left: Original */}
                <div className="space-y-1">
                  <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Original Description</span>
                  <textarea
                ...
                {/* Right: AI Improved */}
                <div className="space-y-1">
                  <span className="text-[10px] font-bold text-indigo-500 uppercase tracking-wider block">AI-Improved Version</span>
                  <div 
              ...
              <div className="flex items-center justify-between pt-1 border-t border-indigo-100">
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-3 py-1 bg-green-600 hover:bg-green-700 text-white rounded text-xs font-semibold shadow-sm transition"
                  >
                    Accept
                  </button>
                  <button
                    ...
                    className="px-3 py-1 bg-white hover:bg-red-50 text-red-600 border border-red-200 rounded text-xs font-semibold shadow-sm transition"
                  >
                    Reject
                  </button>
                </div>
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-2.5 py-1 bg-white hover:bg-gray-50 border border-gray-200 text-gray-600 rounded text-[11px] font-medium transition"
                  >
                    Copy
                  </button>
                  <button
                    onClick={handleSideBySideImprove}
                    disabled={aiLoading.description}
                    className="px-2.5 py-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded text-[11px] font-medium transition flex items-center gap-1 disabled:opacity-50"
                  >
        ...
        <div className="space-y-3">
          ...
          {detailedSuggestedSubtasks.length > 0 && (
            <div className="border border-indigo-200 rounded-lg overflow-hidden bg-indigo-50/10 shadow-sm animate-fade-in my-3">
              {/* Header */}
              <div 
                onClick={() => setShowSuggestedSubtasksCard(!showSuggestedSubtasksCard)}
                className="flex items-center justify-between px-3 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-indigo-200 cursor-pointer hover:bg-indigo-100/50 transition select-none"
              >
                <div className="flex items-center gap-2 text-indigo-800 font-bold text-xs font-sans">
              ...
              {showSuggestedSubtasksCard && (
                <div className="p-2 space-y-2.5 bg-white">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2.5 pl-2 opacity-0 group-hover:opacity-100 transition shrink-0">
                          <button
                            ...
                            className="text-green-600 hover:text-green-800 font-bold text-sm transition cursor-pointer"
                          ...
                          <button
                            ...
                            className="text-gray-400 hover:text-red-500 font-bold text-xs transition cursor-pointer"
                  ...
                  {/* Prompts / Chat Input */}
                  <div className="relative border border-gray-300 rounded-md shadow-sm bg-white overflow-hidden flex items-center pr-2">
                    <input
                      type="text"
                      value={chatInputText}
          ...
          {isAddingSubtask && (
            <div className="space-y-2 mt-2">
              ...
              <div className="border border-gray-200 rounded p-2 flex items-center justify-between bg-white text-xs shadow-sm">
                ...
                <div className="flex gap-1.5">
                  <button
                    ...
                    className="border border-gray-200 rounded px-2.5 py-1 text-[11px] text-gray-700 font-bold hover:bg-gray-50 bg-white transition shadow-sm cursor-pointer disabled:opacity-50"
                  >
              ...
              <div className="border border-blue-500 ring-1 ring-blue-500 rounded p-1.5 flex items-center justify-between bg-white gap-2 shadow-sm">
                <input
                  id="subtask-input"
                  type="text"
                ...
                <div className="flex items-center gap-1 bg-gray-50 border border-gray-200 rounded px-1.5 py-0.5 text-[10px] text-gray-500 font-medium cursor-pointer">
        ...
        <div className="space-y-4 border-t border-gray-200 pt-6">
          ...
          {activeTab === 'AI Docs' && (
            <div className="space-y-4 animate-fade-in text-xs">
              {!docsData ? (
                <div className="text-center py-8 border border-dashed border-gray-200 rounded-lg space-y-3 bg-gray-50/50">
                  ...
                  <button
                    ...
                    className="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded text-xs font-semibold shadow-sm transition flex items-center gap-1 mx-auto cursor-pointer"
                  >
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center bg-indigo-50 border border-indigo-100 p-2.5 rounded-lg">
                    ...
                    <button
                      onClick={handleGenerateDocs}
                      className="px-2 py-1 text-[10px] bg-white border border-gray-200 text-gray-600 rounded hover:bg-gray-50 transition cursor-pointer"
                    >
                      Regenerate
                    </button>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <h4 className="font-bold text-gray-800 uppercase tracking-wider text-[9px] mb-1">Implementation Plan</h4>
                    ...
                    <div>
                      <h4 className="font-bold text-gray-800 uppercase tracking-wider text-[9px] mb-1">QA Testing Checklist</h4>
                    ...
                    <div>
                      <h4 className="font-bold text-gray-800 uppercase tracking-wider text-[9px] mb-1">Deployment Roadmap</h4>
                    ...
                    <div>
                      <h4 className="font-bold text-gray-800 uppercase tracking-wider text-[9px] mb-1">Rollback Plan</h4>
                    ...
                    <div>
                      <h4 className="font-bold text-gray-800 uppercase tracking-wider text-[9px] mb-1">API & Technical Specs</h4>
        ...
        <div className={`${isExpanded ? 'w-1/3 border-l border-gray-200 pl-8 space-y-6' : 'w-full space-y-6'}`}>
          ...
          {isExpanded && (
            <div className="flex items-center gap-2 flex-wrap mb-2">
              <div className="interactive-dropdown relative">
                <button onClick={() => toggleDropdown('status-select')} className={`flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-bold transition ${STATUS_COLORS[currentStatus] || STATUS_COLORS['TO DO']}`}>
              ...
              <div className="interactive-dropdown relative">
                ...
                {openDropdown === 'side-ai-actions' && (
                  <div className="absolute right-0 top-full mt-1.5 w-60 bg-white border border-gray-200 rounded shadow-[0_4px_12px_rgba(0,0,0,0.1)] py-1.5 z-50 text-[14px]">
                    <div onClick={handleSideBySideImprove} className="px-4 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-gray-700 transition font-normal font-sans">
                      <FileEdit size={16} className="text-gray-700" />
                      <span>Improve description</span>
                    </div>
                    <div onClick={handleLinkConfluence} className="px-4 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-gray-700 transition font-normal font-sans">
                      <FileText size={16} className="text-gray-700" />
                      <span>Link Confluence content</span>
                    </div>
                    <div onClick={handleSummarizeComments} className="px-4 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-gray-700 transition font-normal font-sans">
                      <AlignLeft size={16} className="text-gray-700" />
                      <span>Summarize comments</span>
                    </div>
                    <div onClick={handleDetailedSubtaskSuggest} className="px-4 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-gray-700 transition font-normal font-sans">
                      <Network size={16} className="text-gray-700" />
                      <span>Suggest child work items</span>
                    </div>
                    <div onClick={handleLinkSimilar} className="px-4 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-gray-700 transition font-normal">
                      <CopyCheck size={16} className="text-gray-700" />
                      <span>Link similar work items</span>
                    </div>
                  </div>
                  ...
                  {openDropdown === 'details-assignee' ? (
                    <div className="w-full">
                      ...
                      <div
                        ...
                        className="flex items-center gap-2 border border-blue-500 ring-1 ring-blue-500 rounded px-1.5 py-1 bg-white shadow-sm cursor-text mb-1"
                      >
                        <div className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0 ${assignee.name === 'Unassigned' || assignee.name === 'Automatic' ? 'bg-gray-200 text-gray-500' : assignee.color}`}>
                      ...
                      <div className="absolute left-0 top-full bg-white border border-gray-200 rounded-b shadow-lg z-50 min-w-[260px] max-h-64 overflow-y-auto custom-scrollbar">
                        ...
                        {(() => {
                          ...
                          return me ? (
                            <div
                              ...
                              className={`px-3 py-2.5 hover:bg-gray-100 cursor-pointer flex items-center gap-3 transition ${isActive ? 'bg-gray-50 border-l-[3px] border-blue-600' : 'pl-[15px]'}`}
                            >
                        ...
                        <div
                          ...
                          className={`px-3 py-2.5 hover:bg-gray-100 cursor-pointer flex items-center gap-3 transition pl-[15px]`}
                        >
                  ...
                  {openDropdown === 'details-due' ? (
                    <div className="w-full">
                      ...
                      <div
                        ...
                        className="flex items-center border border-blue-500 ring-1 ring-blue-500 rounded bg-white overflow-hidden shadow-sm cursor-pointer"
                      >
                        <input
                          type="text"
                          readOnly
                      ...
                      {/* Calendar Dropdown */}
                      <div className="absolute left-0 top-full mt-1.5 bg-white border border-gray-200 rounded-lg shadow-xl p-3 z-50 text-xs text-gray-800 w-[240px]">

                        {/* Month Navigation */}
                        <div className="flex justify-between items-center mb-3 text-gray-700 font-bold px-1">
                          <div className="flex gap-1.5">
                        ...
                        {/* Weekday Labels */}
                        <div className="grid grid-cols-7 gap-1 text-center text-[10px] font-bold text-gray-500 mb-1.5 font-sans">
                        ...
                        {/* Calendar Grid */}
                        <div className="grid grid-cols-7 gap-1 text-center text-[10px] font-medium text-gray-700 font-sans">
                        ...
                        <div className="flex items-center justify-between text-gray-600 hover:text-gray-800 cursor-pointer pt-1 px-1 transition group">
                          <div className="flex items-center gap-2 font-bold text-[11px] font-sans">
                  ...
                  {openDropdown === 'details-reporter' ? (
                    <div className="w-full">
                      ...
                      <div
                        ...
                        className="flex items-center gap-2 border border-blue-500 ring-1 ring-blue-500 rounded px-1.5 py-1 bg-white shadow-sm cursor-text mb-1"
                      >
                        <div className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0 ${reporter.color}`}>{reporter.initial}</div>
                  ...
                  {openDropdown === 'details-team' ? (
                    <div className="w-full">
                      ...
                      <div
                        ...
                        className="flex items-center gap-2 border border-blue-500 ring-1 ring-blue-500 rounded px-2.5 py-1.5 bg-white text-gray-800 text-xs font-semibold cursor-pointer shadow-sm"
                      >
                      ...
                      {/* Dropdown menu */}
                      <div className="absolute left-0 right-0 top-full mt-1.5 bg-white border border-gray-200 rounded-lg shadow-lg py-1.5 z-50 text-xs text-gray-800 min-w-[220px]">
                        {[
                          ...
                          <div
                            ...
                            className="px-3 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-2.5 transition"
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-[10px] text-gray-400">Team • {t.members} members, including you</div>
                            </div>
                          </div>
                        ))}
                        ...
                        <div
                          ...
                          className="px-3.5 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-2 text-xs font-bold text-gray-700 transition"
                        >
                          <Plus size={14} />
      ...
      {showSubtaskAiModal && subtaskAiDetails && selectedSubtaskForAi && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-[999] animate-fade-in p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl overflow-hidden border border-gray-200 flex flex-col max-h-[80vh]">
            ...
            <div className="p-4 overflow-y-auto flex-1 space-y-4 text-xs font-sans">
              <div className="grid grid-cols-2 gap-4 bg-gray-50 p-3 rounded-lg border border-gray-100">
                <div>
                  ...
                  <span className="font-bold text-gray-800">{selectedSubtaskForAi.subtask.assignee || 'Olivia Taylor'} (Free - 8h workload)</span>
                </div>
                <div>
                  <span className="font-semibold text-gray-500 block">Sprint & Priority Recommendation:</span>
                  <span className="font-bold text-gray-800">{subtaskAiDetails.sprint || 'Sprint 1'} - {subtaskAiDetails.priority || 'Medium'} ({subtaskAiDetails.story_points || 3} SP)</span>
                </div>
              </div>

              <div>
                <span className="font-bold text-indigo-700 block mb-1">Acceptance Criteria</span>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <span className="font-bold text-gray-700 block mb-1">Developer Checklist</span>
                ...
                <div>
                  <span className="font-bold text-gray-700 block mb-1">Testing Checklist</span>
                  <ul className="list-disc pl-4 space-y-1 bg-white border border-gray-200 rounded p-2.5 leading-relaxed">
              ...
              <div>
                <span className="font-bold text-red-600 block mb-1">Risk Analysis & Dependency Mapping</span>
              ...
              <div>
                <span className="font-bold text-gray-700 block mb-1">Implementation Notes</span>
