              ...
              <div className="flex items-end justify-between mb-6">
                <div>
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <button onClick={() => setIsCreateDrawerOpen(true)} className="flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-bold bg-blue-600 text-white hover:bg-blue-700 transition-colors ml-4 shadow-sm">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="relative interactive-dropdown">
                    <button
                      ...
                      className="flex items-center gap-1.5 text-xs font-medium text-gray-600 hover:bg-gray-100 px-3 py-1.5 rounded border border-gray-200 shadow-sm transition-all"
                    >
                      <LayoutList size={14} /> Columns <ChevronDown size={14} />
                    </button>

                    {openFilterDropdown === 'columns' && (
                      <div className="absolute right-0 top-full mt-1.5 w-72 bg-white border border-gray-200 rounded-lg shadow-xl z-50 flex flex-col font-sans text-xs text-gray-700 py-1.5">
                        ...
                        <div className="max-h-72 overflow-y-auto px-1 py-1 custom-scrollbar">
                          {ALL_COLUMNS.filter(col =>
                            ...
                            return (
                              <label
                                key={col.key}
                                className="flex items-center gap-2.5 px-3 py-1.5 hover:bg-gray-50 cursor-pointer rounded"
                                onClick={(e) => e.stopPropagation()}
                              >
                                <input
                                  type="checkbox"
                        ...
                        {/* Dropdown footer */}
                        <div className="flex justify-between items-center px-3 pt-2 pb-0.5 border-t border-gray-100 text-[10px] text-gray-500">
                          <button
                        ...
                        <tr>
                          <td colSpan="100%" className="p-12 text-center">
                            <div className="flex flex-col items-center justify-center text-gray-400">
                              ...
                              <button onClick={() => setIsCreateDrawerOpen(true)} className="px-4 py-2 bg-blue-600 text-white rounded text-xs font-bold hover:bg-blue-700 transition shadow-sm flex items-center gap-1.5"><Plus size={14} /> Create your first issue</button>
                            </div>
                          </td>
                        </tr>
                          ...
                          {ALL_COLUMNS.filter(col => selectedColumns.has(col.key)).map(col => {
                            switch (col.key) {
                              ...
                              case 'status':
                                return (
                                  <td key={col.key} className="p-3">
                                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide border ${row.status === 'TO DO' ? 'bg-gray-100 text-gray-600 border-gray-200' :
                              ...
                              case 'progress':
                                return <td key={col.key} className="p-3 text-gray-700 font-bold">{row.progress || 0}%</td>;
                                ...
                                return (
                                  <td key={col.key} className="p-3">
                                    <div className="flex items-center gap-1">
                                      {row.labels.map(l => (
                                        <span key={l} className="bg-indigo-50 text-indigo-600 border border-indigo-100 px-1.5 rounded text-[10px] font-semibold">{l}</span>
                                      ))}
                                    </div>
                                  </td>
                                );
