    ...
    <div className="bg-[#F8F9FA] min-h-screen p-4 font-sans text-[#1F2020]">
      ...
      <div className="bg-white rounded border border-gray-200 p-6 mb-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <span className="flex items-center gap-1 px-3 py-1.5 bg-red-50 text-red-600 rounded text-xs  border border-red-100">
            <Lock size={14} /> Private
          </span>
          <div className="relative">
            <button 
              onClick={() => setIsStatusMenuOpen(!isStatusMenuOpen)}
              className="flex items-center gap-1 px-4 py-2 bg-green-600 text-white rounded text-xs font-[500] hover:bg-green-700 transition-colors"
            >
        ...
        <div className="col-span-12 lg:col-span-4 space-y-3">
          ...
          <div className="bg-white rounded border border-gray-200 p-2">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="text-red text-[10px] font-[500] flex items-center gap-1 hover:underline">
          ...
          <div className="bg-white rounded border border-gray-200 p-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-2 py-1 bg-green-50 text-green-600 rounded text-[10px] font-[500] border border-green-100">Collab</span>
              <span className="px-2 py-1 bg-amber-50 text-amber-600 rounded text-[10px] font-[500] border border-amber-100">VIP</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded border border-gray-200 p-2">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-2.5 py-1 bg-gray-50 border border-gray-100 rounded text-[10px]  text-gray-600">Devops Design</span>
              <span className="px-2.5 py-1 bg-gray-50 border border-gray-100 rounded text-[10px]  text-gray-600">Margrate Design</span>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-[11px] font-[500] text-gray-900">Steve Vaughan</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <img src="https://i.pravatar.cc/100?u=jessica" alt="" className="w-8 h-8 rounded-full object-cover" />
                <div className="flex-1">
                  <p className="text-[11px] font-[500] text-gray-900">Jessica Sen</p>
                </div>
              </div>
            ...
            <div className="flex border-b border-gray-200">
              {['Activities', 'Notes', 'Calls', 'Files', 'Email'].map((tab) => (
                <button
                  ...
                  className={`p-4  text-xs font-[500] transition-all relative ${
              ...
              {activeTab === 'Activities' && (
                <div className="space-y-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button className="flex items-center gap-1.5 px-3 py-1.5 border border-gray-200 rounded text-xs text-gray-600 font-[500]">
                        ...
                        {items.map((item, idx) => (
                          <div key={idx} className="flex gap-4 group">
                            <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 shadow-sm ${
                              item.activity_type === 'Call' ? 'bg-teal-100 text-teal-600' : 
                            ...
                            <div className="flex-1 bg-white border border-gray-100 rounded-lg p-4 group-hover:border-gray-200 transition-all">
                              <div className="flex justify-between mb-1">
                                <h4 className="text-xs font-[500] text-gray-900">{item.title}</h4>
                                <span className="text-[10px] text-gray-400 ">{formatDateTime(item.created_at).split(',')[1]}</span>
                              </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 border border-gray-100 rounded-lg p-4">
                        <div className="flex justify-between items-center mb-1">
                          ...
                          <span className="text-[10px] text-gray-400">10:25 pm</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 border border-gray-100 rounded-lg p-4">
                        <div className="flex justify-between items-center mb-1">
                          ...
                          <span className="text-[10px] text-gray-400">09:25 pm</span>
                        </div>
                      </div>
                    </div>

                    <div className="flex gap-4">
                      <div className="w-10 h-10 rounded-lg bg-red-500 text-white flex items-center justify-center shrink-0">
                        <FileText size={20} />
                      </div>
                      <div className="flex-1 border border-gray-100 rounded-lg p-4">
                        <div className="flex justify-between items-center mb-1">
                  ...
                  <div className="mt-10 bg-[#FAFAFA] border border-gray-100 rounded-lg p-6 space-y-6">
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[10px] text-gray-400 mt-2">25 Jul 2023, 05:00 pm</p>
                      </div>
                    </div>

                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        <label className="text-[10px] font-[500] text-gray-500 block mb-1.5 uppercase">Reminder *</label>
                        <div className="relative">
                      ...
                      <div>
                        <label className="text-[10px] font-[500] text-gray-500 block mb-1.5 uppercase">Task Priority *</label>
                        <div className="relative">
                          <select className="w-full p-2  bg-white border border-gray-200 rounded text-xs  outline-none appearance-none">
                            <option>High</option>
                            <option>Medium</option>
                      ...
                      <div>
                        <label className="text-[10px] font-[500] text-gray-500 block mb-1.5 uppercase">Assigned To *</label>
                        <div className="relative">
                          <select className="w-full p-2  bg-white border border-gray-200 rounded text-xs  outline-none appearance-none">
