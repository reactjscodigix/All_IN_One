  ...
  return (
    <div className="w-full bg-[#F8FAFC] min-h-screen p-2 font-sans">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3">
            <div className="text-right">
              ...
              <p className="text-[11px] text-[#1F2020]">{user?.role || 'Sales Representative'}</p>
            </div>
            <div className="w-5 h-5 rounded overflow-hidden border-2 border-white shadow-sm bg-gray-200">
              {user?.avatar ? (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
        {stats.map((item, idx) => (
          <div key={idx} className="bg-white p-2 rounded border border-gray-100 shadow-sm">
            <p className="text-[13px] text-gray-500 mb-2">{item.title}</p>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-xl  text-gray-900">{item.value}</span>
              {item.icon}
            </div>
            <p className="text-[11px] text-[#1F2020]">{item.sub}</p>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-3 mb-6">
        {/* Pipeline Overview */}
        <div className="lg:col-span-2 bg-white p-2 rounded border border-gray-100 shadow-sm">
        ...
        <div className="bg-white p-2 rounded border border-gray-100 shadow-sm flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div className="bg-white p-2 roundedl border border-gray-100 shadow-sm">
          <h3 className="text-sm text-gray-500 mb-4">Sales Targets</h3>
          <div className="flex items-end gap-3 mb-4">
            <span className="text-2xl  text-gray-900">48%</span>
            <div className="flex items-center gap-0.5 text-green-500 text-[11px] pb-1">
              <ArrowUp size={12} />
              <span>+2.3%</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px]  text-gray-700">79%</span>
              </div>
            </div>
          </div>
        </div>
