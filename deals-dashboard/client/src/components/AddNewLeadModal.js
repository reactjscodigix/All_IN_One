              ...
              {ownerDropdownOpen && (
                <div className="absolute bottom-full left-0 right-0 mb-1 bg-white border border-gray-300 rounded  shadow-lg z-20 max-h-48 overflow-y-auto">
                  {users.map(user => (
                    ...
                    >
                      <div className="w-8 h-8 rounded-full bg-red-500 text-white flex items-center justify-center text-[10px] flex-shrink-0">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 p-2 border border-gray-300 rounded  bg-white min-h-[40px]">
              {formData.tags.map((tag, idx) => (
                <span key={idx} className="bg-red-50 text-red-700 px-2 py-0.5 rounded-full text-[10px] flex items-center gap-1 border border-red-200">
                  {tag}
                  <button
                    type="button"
