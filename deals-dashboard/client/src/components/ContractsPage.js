      ...
      <div className="bg-white border-b p-2  flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="border border-gray-300 px-3 py-2 rounded  text-xs  bg-white hover:bg-gray-50 transition-colors text-gray-600">
            ⟳
          </button>
          <button 
      ...
      <div className="bg-white p-2  border-b">
        <div className="flex items-center gap-3 mb-4">
          ...
          <button 
            ...
            className="border border-gray-300 px-3 py-2 rounded  text-xs  bg-white hover:bg-gray-50 transition-colors flex items-center gap-2"
          >
            <Filter size={16} />
            Filter
          </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 p-2 bg-gray-50 rounded ">
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-300 px-3 py-2 rounded  text-xs  focus:outline-none focus:ring-2 focus:ring-red-500"
              >
