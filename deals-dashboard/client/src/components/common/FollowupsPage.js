        ...
        <div key={column.id} className="flex-shrink-0 w-80 flex flex-col gap-2">
          ...
          <div className="flex-1 flex flex-col gap-2">
            {column.items.map(item => (
              <div
                key={item.id}
                className="bg-white p-2 rounded border border-gray-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer group"
  ...
  return (
    <div className="p-2 bg-[#F7F8F9] min-h-screen space-y-3">
      ...
      <div className="">
          ...
          <div className="flex items-center  p-1 rounded mb-2">
            {tabs.map(tab => (
              <button
                ...
                className={`px-3 py-1.5 rounded-md text-xs  transition-all ${activeTab === tab
        ...
        <div className="p-0">
          {isGroupedView ? (
            <div className="bg-white border border-gray-200 rounded shadow-sm overflow-hidden mx-2 mb-4">
