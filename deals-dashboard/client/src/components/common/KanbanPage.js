                                          ...
                                          <Draggable key={card.key} draggableId={card.key} index={idx}>
                                            {(provided, snapshot) => (
                                              <div
                                                ...
                                                className={`bg-white border rounded p-3 shadow-sm hover:shadow-md transition-shadow ${selectedIssue === card.key ? 'ring-2 ring-blue-500 border-transparent' : 'border-gray-200'} ${snapshot.isDragging ? 'shadow-lg rotate-2' : ''}`}
                                              >
