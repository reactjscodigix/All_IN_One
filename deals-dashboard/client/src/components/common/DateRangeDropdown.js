  ...
  return (
    <div className="relative">
      <button
        ...
        className={`p-2 rounded text-xs   transition-colors flex items-center gap-2 border border-1 border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 ${
          isOpen
