      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="pt-4 flex justify-end gap-2">
            <button type="button" onClick={onClose} className="px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded border border-gray-200">
              Cancel
            </button>
            <button type="submit" disabled={isLoading} className="px-4 py-2 text-sm text-white bg-blue-600 hover:bg-blue-700 rounded disabled:opacity-50">
