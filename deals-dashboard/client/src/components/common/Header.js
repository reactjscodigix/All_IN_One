        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="relative">
              ...
              {showQuickAccess && (
                <div className="dropdown-menu absolute right-0 mt-2 w-56 bg-white z-50 rounded-lg shadow-xl border border-gray-100 py-1">
                  <div className="p-2 space-y-1">
                    {quickAccessMenu.map((item, idx) => (
                      ...
                      >
                        ...
                        <p className="text-[11px] text-gray-500 group-hover:text-gray-600 transition-colors">{item.desc}</p>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="relative">
              ...
              {showHelp && (
                <div className="dropdown-menu absolute right-0 mt-2 w-64 bg-white z-50 p-4 rounded-lg shadow-xl border border-gray-100">
            ...
            <div className="relative">
              ...
              {showMessages && (
                <div className="dropdown-menu absolute right-0 mt-2 w-80 bg-white z-50 rounded-lg shadow-xl border border-gray-100 py-1">
                    ...
                    {messagesData.map((msg, idx) => (
                      ...
                      >
                        <div className="flex gap-3">
                          <div className={`w-9 h-9 rounded-full ${msg.avatarColor} flex items-center justify-center text-white text-xs font-bold shrink-0 shadow-sm`}>
                            {msg.avatar}
                          </div>
                ...
                <div className="dropdown-menu absolute right-0 mt-2 w-80 bg-white z-50 rounded-lg shadow-xl border border-gray-100 py-1">
                  ...
                  <div className="max-h-80 overflow-y-auto">
                    {notificationsData.map((notif, idx) => (
                      ...
                      >
                        <div className="flex gap-3">
                          <div className={`w-9 h-9 rounded-full ${notif.avatarColor} flex items-center justify-center text-white text-xs font-bold shrink-0 shadow-sm`}>
                            {notif.avatar}
                          </div>
                          <div className="flex-1 min-w-0">
            ...
            <div className="relative">
              <button
                ...
                title="Profile"
              >
                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-pink-300 to-pink-500 flex items-center justify-center text-white text-xs font-bold border-2 border-green-400 hover-lift">
                ...
                <div className="dropdown-menu absolute right-0 mt-2 w-56 bg-white z-50 rounded-lg shadow-xl border border-gray-100 py-1">
                  <div className="p-3 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white rounded-t-lg">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-300 to-pink-500 flex items-center justify-center text-white text-xs font-bold shrink-0">
                        {user?.name?.charAt(0).toUpperCase() || 'U'}
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-bold text-gray-900 truncate">{user?.name || 'User'}</p>
                        <p className="text-[10px] text-gray-600 truncate">{user?.role || 'Member'}{user?.department ? ` • ${user.department}` : ''}</p>
