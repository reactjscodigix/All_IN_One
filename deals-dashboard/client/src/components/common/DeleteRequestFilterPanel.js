    ...
    <>
      ...
      <div className="absolute top-16 left-4 bg-white border border-gray-200 rounded  shadow-xl z-50 w-96 max-h-96 overflow-hidden flex flex-col">
        ...
        <div className="bg-white border-t border-gray-200 p-3 flex gap-2">
          <button
            onClick={handleReset}
            className="flex-1 px-3 py-1.5 text-gray-700   text-xs  border border-gray-300 rounded hover:bg-gray-50 transition-colors"
          >
            Reset
          </button>
          <button
            onClick={handleFilter}
            className="flex-1 px-3 py-1.5 bg-red-600  text-white   text-xs  rounded hover:bg-blue-700 transition-colors"
          >
            Filter
          </button>
        </div>
