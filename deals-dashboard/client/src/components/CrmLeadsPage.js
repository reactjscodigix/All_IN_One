                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="flex items-center gap-3 mb-1">
                            <div className={`w-2.5 h-2.5 rounded-full ${statusColors[statusObj.status]?.dot || 'bg-blue-500'} shadow-sm`}></div>
                        ...
                        <div className="flex items-center gap-1 relative">
                          ...
                          <button 
                            ...
                            className="hover:bg-red-600  p-1 rounded transition-colors shadow-sm hover:opacity-90 hover:text-white"
                          >
                          ...
                          {columnMenuOpen === statusObj.status && (
                            <div className="absolute top-full right-0 mt-1 w-32 bg-white border border-gray-100 rounded shadow-xl z-50 py-1 animate-in fade-in slide-in-from-top-1 duration-150">
                              <button className="w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-gray-50 transition-colors ">
                                Edit
                              </button>
                              <button className="w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-gray-50 transition-colors ">
                                Delete
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="space-y-1.5 mt-2">
                                ...
                                <div className="flex items-center gap-2 text-xs">
                                  ...
                                  <span className={`px-2 py-0.5 rounded-full text-[10px] font-[500]  ${sourceColors[lead.source]?.light || 'bg-gray-50'} ${sourceColors[lead.source]?.text || 'text-gray-600'}`}>
