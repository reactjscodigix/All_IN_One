      ...
      <div className="border-b border-[#EAECF0]">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-gray-900 text-sm">Visualization</span>
          </div>
          <ChevronDown 
            size={18} 
            className={`text-gray-500 transition ${openPanels.chart ? 'rotate-180' : ''}`}
          />
        </button>
      ...
      <div className="border-b border-[#EAECF0]">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-gray-900 text-sm">Analysis Breakdown</span>
          </div>
          <ChevronDown 
            size={18} 
            className={`text-gray-500 transition ${openPanels.breakdown ? 'rotate-180' : ''}`}
          />
        </button>

        {openPanels.breakdown && (
          <div className="px-6 py-5 space-y-3 border-t border-[#EAECF0] bg-white" style={{ overflow: 'visible' }}>
      ...
      <div className="border-b border-[#EAECF0]">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-gray-900 text-sm">Summary</span>
          </div>
          <ChevronDown 
            size={18} 
            className={`text-gray-500 transition ${openPanels.summary ? 'rotate-180' : ''}`}
          />
        </button>
          ...
          <div className="px-6 py-5 border-t border-[#EAECF0] bg-white">
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <p className="text-xs text-gray-600 mb-2">Total Leads</p>
                <p className="text-2xl font-bold text-gray-900">{totalLeads}</p>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <p className="text-xs text-gray-600 mb-2">Highest Stage</p>
                <p className="text-2xl font-bold text-gray-900">Conversation</p>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <p className="text-xs text-gray-600 mb-2">Conversion Rate</p>
                <p className="text-2xl font-bold text-gray-900">56.25%</p>
              </div>
            </div>
          </div>
        )}
