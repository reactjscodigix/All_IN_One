    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="bg-red-600 text-white px-4 py-2 rounded   hover:bg-blue-700 flex items-center gap-2"
        >
          <Plus size={20} />
          Create Role
        </button>
        ...
        <div className="bg-white rounded  border border-gray-200 p-6">
          ...
          <form onSubmit={handleCreateRole} className="space-y-4">
            ...
            <div className="flex gap-2">
              <button
                type="submit"
                className="flex-1 bg-red-600  text-white px-4 py-2 rounded   hover:bg-blue-700"
              >
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50 border-b">
                    <tr>
                      <th className="px-4 py-2 text-left text-sm  text-gray-900">Module</th>
                      {actions.map(action => (
                        <th key={action} className="px-4 py-2 text-center text-sm  text-gray-900">
                          {action}
                        </th>
                      ))}
                    </tr>
                  ...
                  <tbody>
                    {modules.map(module => (
                      <tr key={module} className="border-b hover:bg-gray-50">
                        <td className="px-4 py-2  text-gray-900">{module}</td>
                        {actions.map(action => {
