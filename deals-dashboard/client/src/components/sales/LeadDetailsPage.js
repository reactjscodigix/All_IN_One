                      ...
                      <div key={groupIdx} className="mb-8 last:mb-0">
                        ...
                        <div className="flex items-center gap-4 mb-4 relative">
                          <div className="relative z-10 shrink-0">
                            <div className={`w-10 h-10 rounded flex items-center justify-center shadow-sm ${group.type === 'Company' ? 'bg-indigo-600 text-white' :
                          ...
                          {group.items.map((item, itemIdx) => (
                            <div key={itemIdx} className="flex items-center gap-4 py-2 hover:bg-gray-50/50 rounded transition-colors px-2 relative group">
                              <div className="relative flex items-center justify-center shrink-0">
                                ...
                                <div className="w-8 h-8 rounded bg-white flex items-center justify-center z-10 border border-gray-100 shadow-sm transition-transform group-hover:scale-110">
                      ...
                      {call.ai_summary && (
                        <div className="mt-3 p-3 bg-blue-50/50 rounded border border-blue-100/50 animate-in fade-in duration-500">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <h5 className="text-xs  text-blue-900 uppercase tracking-wider">AI Meeting Summary</h5>
                          </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="bg-red-600 text-white px-3 py-1.5 rounded text-xs font-[500] flex items-center gap-1 hover:bg-red-700 transition-colors"
                    >
