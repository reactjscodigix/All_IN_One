                ...
                <div className="space-y-8">
                      ...
                      <div className="space-y-6 pl-4 border-l border-gray-100 ml-1.5">
                        {items.map((item, idx) => (
                          <div key={idx} className="flex gap-4 group">
                            <div className={`w-8 h-8 rounded flex items-center justify-center shrink-0 shadow-sm ${item.activity_type === 'Call' ? 'bg-teal-100 text-teal-600' :
                  ...
                  <div className="mt-10 bg-[#FAFAFA] border border-gray-100 rounded p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        <label className="text-xs font-[500] text-gray-500 block mb-1.5 uppercase">Reminder *</label>
                        <div className="relative">
                      ...
                      <div>
                        <label className="text-xs font-[500] text-gray-500 block mb-1.5 uppercase">Task Priority *</label>
                        <div className="relative">
                          <select className="w-full p-2  bg-white border border-gray-200 rounded text-xs  outline-none appearance-none">
                            <option>High</option>
                            <option>Medium</option>
                      ...
                      <div>
                        <label className="text-xs font-[500] text-gray-500 block mb-1.5 uppercase">Assigned To *</label>
                        <div className="relative">
                          <select className="w-full p-2  bg-white border border-gray-200 rounded text-xs  outline-none appearance-none">
