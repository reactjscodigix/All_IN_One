      ...
      <div className="mb-3 flex items-center justify-between animate-fade-in">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 border border-gray-200 rounded  bg-white p-2 text-xs  text-gray-700 hover:border-red-500 hover:text-red-500 transition-all shadow-sm focus:outline-none"
          >
            <Calendar size={16} />
