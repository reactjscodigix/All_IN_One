  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/20 print:bg-white print:p-0">
      <div className="min-h-screen flex items-start justify-center py-8 px-4 print:p-0 print:bg-white print:py-0">
        <div className="w-full max-w-5xl bg-white rounded  shadow-sm border border-gray-200 print:rounded-none print:shadow-none print:border-0">
              ...
              <table className="w-full text-xs ">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    <th className="px-3 py-2 text-left  text-gray-900">Job Description</th>
                    <th className="px-3 py-2 text-center  text-gray-900">Qty</th>
                    <th className="px-3 py-2 text-right  text-gray-900">Price</th>
                    <th className="px-3 py-2 text-right  text-gray-900">Discount</th>
                    <th className="px-3 py-2 text-right  text-gray-900">Total</th>
                  </tr>
                </thead>
                <tbody>
                  {items && items.length > 0 ? (
                    items.map((item, idx) => {
                      ...
                      return (
                        <tr key={idx} className="border-b border-gray-200 hover:bg-gray-50">
                          ...
                          <td className="px-3 py-2 text-right text-gray-700">{formatINR(itemRate)}</td>
                          <td className="px-3 py-2 text-right text-gray-700">{formatINR(itemDiscountAmount)}</td>
                          <td className="px-3 py-2 text-right   text-gray-900">{formatINR(itemTotal)}</td>
                        </tr>
                      );
                    })
                  ) : (
                    <tr className="border-b border-gray-200">
                      ...
                      <td className="px-3 py-2 text-right text-gray-700">{formatINR(invoice?.subtotal)}</td>
                      <td className="px-3 py-2 text-right text-gray-700">{formatINR(invoice?.discount_amount || 0)}</td>
                      <td className="px-3 py-2 text-right   text-gray-900">{formatINR((invoice?.subtotal || 0) - (invoice?.discount_amount || 0))}</td>
                    </tr>
                  )}
                </tbody>
              </table>
